...
export const VAULT_ABI = [
  ...
  { name: 'depositDual',          type: 'function', stateMutability: 'nonpayable', inputs: [{ name: 'amount0', type: 'uint256' }, { name: 'amount1', type: 'uint256' }, { name: 'minShares', type: 'uint256' }], outputs: [{ name: 'shares', type: 'uint256' }] },
  // Events
